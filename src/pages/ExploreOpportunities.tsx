...
import { Menu, X, ChevronDown, User, Users, Shield, GraduationCap,ArrowBigLeft } from "lucide-react";
...
const ExploreOpp = () => {
  ...
  // Rest of the CareerPortal component remains the same...
  const jobListings = [
    {
      id: 1,
